...
if __name__ == "__main__":
    ...
    if equations:
        ...
        # Resultados
        print_equation_results("Resolucion de ecuaciones (Secuencial)", seq_eq_results, seq_eq_time)
        print_equation_results("Resolucion de ecuaciones (Paralelo)", par_eq_results, par_eq_time, paralelo=True)
